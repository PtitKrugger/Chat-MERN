...
export default function MainPage() {
    ...
    // Handle transitions between ContactBar and Chat panel
    ...
    async function slideTo(panel: "ChatPanel" | "ContactBar") {
        if (panel === "ChatPanel") {
            ...
            <div className={`${isChatDivSliding ? "transition-all duration-700 ease-in-out translate-x-full" : "translate-x-1"} h-screen`}>
                ...
                <div className="flex h-[14%] w-full items-center gap-4 border-b bg-white p-4">
                    ...
                    <div className='flex h-[100%] w-[100%] justify-end items-center pr-2'>
                        <Undo2 height={32} width={32} onClick={() => slideTo("ContactBar")} className="cursor-pointer rounded-md bg-gray-100 p-1 shadow-md transition-transform duration-200 hover:scale-110" />
                    </div>
                </div>
